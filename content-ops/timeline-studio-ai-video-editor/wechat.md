...
![字幕对齐预览](/root/blog/static/images/timeline-studio-ai-video-editor/voice-caption-alignment.png)
...
- ❌ 完全不会代码，只想点点点就能用（在线版其实也可以，但问题不如客户端成熟）
